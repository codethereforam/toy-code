...
function parseOutboundCSV(csvString) {
    ...
    for (let line of lines) {
        ...
        let outbound = new Outbound(lineParts[1], lineParts[0], parseInt(lineParts[2]));
...
// console.log(Object.keys(groupedOutboundList));
// console.log(Object.values(groupedOutboundList));
